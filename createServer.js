...
const npmCachePackageInfo = process.env.NPM_CACHE_PACKAGE_INFO === 'true';
const npmCachePackageContent = process.env.NPM_CACHE_PACKAGE_CONTENT === 'true';
