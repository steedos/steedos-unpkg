...
function FolderViewer(_ref) {
  ...
  var _Object$keys$reduce = Object.keys(entries).reduce(function (memo, key) {
    ...
    files: []
      ...
      files = _Object$keys$reduce.files; // REPLACED: Native string sorting using localeCompare
...
function createServer() {
  const app = createApp(app => {
    ...
    app.use('/browse', createApp(app => {
      app.enable('strict routing');
      app.get('*dir/', noQuery(), validatePackagePathname, validatePackageName, validatePackageVersion, serveDirectoryBrowser$1);
      app.get('*file', noQuery(), validatePackagePathname, validatePackageName, validatePackageVersion, serveFileBrowser$1);
    ...
    const metadataApp = createApp(app => {
      app.enable('strict routing');
      app.get('*dir/', allowQuery('meta'), validatePackagePathname, validatePackageName, validatePackageVersion, validateFilename, serveDirectoryMetadata$1);
      app.get('*file', allowQuery('meta'), validatePackagePathname, validatePackageName, validatePackageVersion, validateFilename, serveFileMetadata$1);
    });
    ...
    const moduleApp = createApp(app => {
      app.enable('strict routing');
      app.get('*module', allowQuery('module'), validatePackagePathname, validatePackageName, validatePackageVersion, validateFilename, findEntry$3, serveModule);
    });
    app.use((req, res, next) => {
      if (req.query.module != null) {
        moduleApp(req, res);
    ...
    app.get('*new', noQuery(), validatePackagePathname, validatePackageName, validatePackageVersion, validateFilename, findEntry$3, serveFile);
  });
